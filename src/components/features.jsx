...
const features = () => {
  return (
    <div
      id="features"
      className="mx-[42px] mt-[100px] flex flex-col gap-10.5 justify-items-center"
    >
      ...
      <div className="flex flex-col justify-center items-center gap-[64px]">
        ...
        <motion.span
          ...
          viewport={{ once: true }}
          className="w-[100%] flex justify-center items-center gap-[74px] self-stretch"
        >
          {/* image1___________ */}
        ...
        <motion.span
          ...
          transition={{ duration: 1.5, ease: "easeOut" }}
          viewport={{ once: true }}
          className=" w-[100%] flex flex-row-reverse justify-center items-center gap-[74px] self-stretch"
        >
          <span className="w-74.75 h-73.5 aspect-60/59">
