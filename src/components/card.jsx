  ...
  return (
    <div className="mx-[42px] mt-[100px] flex flex-col justify-center items-center gap-10.5">
      ...
      <div className=" w-[100%] flex justify-center items-center self-stretch gap-[80px]">
        {/* card 1________ */}
        <span className="bg-[#F3E6DD] w-103 h-80 px-3.5 py-3 flex flex-col justify-center items-center gap-2.5 rounded-[20px] hover:bg-[#f3dac8] transition-colors duration-300">
