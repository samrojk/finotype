    ...
    <div className="mx-[42px] mt-[42px] flex flex-col justify-center items-center gap-[32px] ">
      ...
      <form className="w-full max-w-[835px] flex flex-col justify-center items-center gap-[42px] ">
        ...
        <div className="w-full flex flex-col justify-center items-center self-stretch gap-[20px]">
          ...
          <span className="w-full flex justify-center items-center gap-[10px] ">
            <span className="w-[225px] h-[64px] px-[25px] py-[12px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#D5D5D5]">
              <p className="text-[#1A1A1A] text-[18px] font-medium leading-normal">Fixed Costs</p>
            </span>
            ...
            <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
              ...
              <span className=" w-full max-w-[586px] flex justify-between items-center">
                {/* ----------------------------------- */}
                <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter all your fixed monthly expenses" />
          ...
          <span className="w-full flex justify-center items-center gap-[10px] ">
            <span className="w-[225px] h-[64px] px-[25px] py-[12px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#D5D5D5]">
              <p className="text-[rgb(26,26,26)] text-[18px] font-medium leading-normal">Variable Costs</p>
            </span>
            ...
            <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
              ...
              <span className=" w-full max-w-[586px] flex justify-between items-center">
                {/* ----------------------------------- */}
                <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter cost per unit/service" />
                ...
                <span className="flex justify-center items-center gap-[10px] ">
                  ...
                  <span className="px-[25px] py-[12px] w-[168px] h-[52px] bg-[#FFF8F2] flex flex-col justify-center items-center gap-[10px] rounded-[100px] ">
                    ...
                    <div className="relative flex justify-center items-center gap-[10px] ">
                      ...
                      >
                        <option value="unit" className="bg-[#F3E6DD] ">Unit</option>
                        <option value="service" className="bg-[#F3E6DD] ">Service</option>
                        {/* <option value="yearly" className="bg-[#F3E6DD] ">Yearly</option> */}
                      </select>
                      <FaChevronDown
                        size={18}
          ...
          <span className="w-full flex justify-center items-center gap-[10px] ">
            <span className="w-[225px] h-[64px] px-[25px] py-[12px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#D5D5D5]">
              <p className="text-[#1A1A1A] text-[18px] font-medium leading-normal">Revenue per Sale</p>
            </span>
            ...
            <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
              ...
              <span className=" w-full max-w-[586px] flex justify-between items-center">
                {/* ----------------------------------- */}
                <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter selling price per unit/service" />
