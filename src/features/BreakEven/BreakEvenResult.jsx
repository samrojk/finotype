...
const BreakEvenResult = () => {
    ...
    const cards = [
        {
            id: 1,
            title: "Profit at 10K Sales",
            amount: "$180,000",
            subText: "This is the Total earnings generated",
        },
        {
            id: 2,
            title: "BreakEven Units",
            amount: "1,000 Units",
            subText: "Units required to fully recover overall costs",
        },
        {
            id: 3,
            title: "CM per Unit",
            amount: "$20",
            subText: "Profit margin earned on each product unit",
        },
        {
            id: 4,
            title: "BreakEven Sales",
            amount: "$50,000",
            subText: "Sales needed to break even without losses",
        },
    ];
...
export default BreakEvenResult;