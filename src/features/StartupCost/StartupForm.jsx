            ...
            <div className="w-full flex flex-col justify-center items-center self-stretch gap-[20px]">
              ...
              <span className="w-full flex justify-center items-center gap-[10px] ">
                ...
                <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
                  ...
                  <span className=" w-full max-w-[586px] flex justify-between items-center">
                    {/* ----------------------------------- */}
                    <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter your total subscription costs" />
              ...
              <span className="w-full flex justify-center items-center gap-[10px] ">
                ...
                <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
                  ...
                  <span className=" w-full max-w-[586px] flex justify-between items-center">
                    {/* ----------------------------------- */}
                    <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter your licensing costs" />
              ...
              <span className="w-full flex justify-center items-center gap-[10px] ">
                ...
                <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
                  ...
                  <span className=" w-full max-w-[586px] flex justify-between items-center">
                    {/* ----------------------------------- */}
                    <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter your employee costs" />
                    ...
                    <span className="flex justify-center items-center gap-[10px] ">
                      ...
                      <span className="px-[25px] py-[12px] w-[168px] h-[52px] bg-[#FFF8F2] flex flex-col justify-center items-center gap-[10px] rounded-[100px] ">
                        ...
                        <div className="relative flex justify-center items-center gap-[10px] ">
                          <select onClick={() => setIsDropdownOpen5(!isDropdownOpen5)} onChange={""} className=" appearance-none px-[25px] py-[12px] pr-[40px] text-[#1A1A1A] text-[18px] font-medium leading-normal  focus:outline-none  "
                          >
                            <option value="onetime" className="bg-[#F3E6DD] ">One Time</option>
                            <option value="monthly" className="bg-[#F3E6DD] ">Monthly</option>
                            <option value="yearly" className="bg-[#F3E6DD] ">Yearly</option>
                          ...
                          <FaChevronDown
                            size={18}
                            className={`absolute right-5 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none transition-transform duration-200 ${isDropdownOpen5 ? "rotate-180" : "rotate-0"
                              }`}
                          />
                        </div>
                      </span>
              ...
              <span className="w-full flex justify-center items-center gap-[10px] ">
                ...
                <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
                  ...
                  <span className=" w-full max-w-[586px] flex justify-between items-center">
                    {/* ----------------------------------- */}
                    <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter your marketing costs" />
                    ...
                    <span className="flex justify-center items-center gap-[10px] ">
                      ...
                      <span className="px-[25px] py-[12px] w-[168px] h-[52px] bg-[#FFF8F2] flex flex-col justify-center items-center gap-[10px] rounded-[100px] ">
                        ...
                        <div className="relative flex justify-center items-center gap-[10px] ">
                          <select onClick={() => setIsDropdownOpen6(!isDropdownOpen6)} onChange={""} className=" appearance-none px-[25px] py-[12px] pr-[40px] text-[#1A1A1A] text-[18px] font-medium leading-normal  focus:outline-none  "
                          >
                            <option value="onetime" className="bg-[#F3E6DD] ">One Time</option>
                            <option value="monthly" className="bg-[#F3E6DD] ">Monthly</option>
                            <option value="yearly" className="bg-[#F3E6DD] ">Yearly</option>
                          ...
                          <FaChevronDown
                            size={18}
                            className={`absolute right-5 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none transition-transform duration-200 ${isDropdownOpen6 ? "rotate-180" : "rotate-0"
                              }`}
                          />
                        </div>
                      </span>
              ...
              <span className="w-full flex justify-center items-center gap-[10px] ">
                ...
                <span className="w-full max-w-[600px] h-[64px] py-[10px] flex flex-col justify-center items-center gap-[10px] rounded-[100px] border-[2px] border-solid border-[#F1F1F1] ">
                  ...
                  <span className=" w-full max-w-[586px] flex justify-between items-center">
                    {/* ----------------------------------- */}
                    <input type="number" className=" px-[12px] w-full  text-[#1A1A1A] text-[18px] font-normal leading-normal tracking-[0.72px] outline-none focus:ring-0 selection:bg-[#EEBC73]" placeholder="enter your monthly expenses" />
                    ...
                    <span className="flex justify-center items-center gap-[10px] ">
                      ...
                      <span className="px-[25px] py-[12px] w-[168px] h-[52px] bg-[#FFF8F2] flex flex-col justify-center items-center gap-[10px] rounded-[100px] ">
                        {/* ----------------------------------- */}
                        <div className="relative flex justify-center items-center gap-[10px] ">
                          <select onClick={() => setIsDropdownOpen7(!isDropdownOpen7)} onChange={""} className=" appearance-none px-[25px] py-[12px] pr-[40px] text-[#1A1A1A] text-[18px] font-medium leading-normal  focus:outline-none  "
                          >
                            <option value="onetime" className="bg-[#F3E6DD] ">One Time</option>
                            <option value="monthly" className="bg-[#F3E6DD] ">Monthly</option>
                            <option value="yearly" className="bg-[#F3E6DD] ">Yearly</option>
                          ...
                          <FaChevronDown
                            size={18}
                            className={`absolute right-5 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none transition-transform duration-200 ${isDropdownOpen7 ? "rotate-180" : "rotate-0"
                              }`}
                          />
                        </div>
                      </span>
